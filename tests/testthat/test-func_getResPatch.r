...
testthat::test_that("patch calc on empirical data", {
  ...
  inference_output <- watlastools::wat_infer_residence(
    data = somedata,
  ...
  testoutput <- watlastools::wat_make_res_patch(
...
testthat::test_that("patch data access function works", {
  ...
  data_access_smry <- watlastools::wat_get_patch_summary(
    res_patch_data =
      copy(testoutput),
    which_data = "summary"
  )
  ...
  data_access_sf <- watlastools::wat_get_patch_summary(
    res_patch_data =
      copy(testoutput),
    which_data = "spatial"
  )
  ...
  # access testoutput spatial
  data_access_pt <- watlastools::wat_get_patch_summary(
    res_patch_data =
      copy(testoutput),
    which_data = "points"
  )
