  ...
  tryCatch(
    {
      ...
      edge_data_summary <- edge_data[, list(
        patch, time_start, time_end,
        x_start, x_end,
        y_start, y_end,
        tide_number
      )]
      ...
      edge_data_summary[, `:=`(
        new_tide_number = data.table::nafill(
          tide_number,
          "locf"
        ),
        newpatch = data.table::nafill(newpatch, "locf")
      )]
      edge_data_summary <- edge_data_summary[, list(
        tide_number, patch,
      ...
      edge_data[, distBwPatch := wat_bw_patch_dist(
        data = tempdata,
        x1 = "x_end", x2 = "x_start",
        y1 = "y_end", y2 = "y_start"
      )]
